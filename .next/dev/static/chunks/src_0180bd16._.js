    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Hero.useEffect": ()=>{
            const progressInterval = setInterval({
                "Hero.useEffect.progressInterval": ()=>{
                    setProgress({
                        "Hero.useEffect.progressInterval": (prev)=>{
                            if (prev >= 100) {
            ...
            }["Hero.useEffect.progressInterval"], 50);
            return ({
                "Hero.useEffect": ()=>clearInterval(progressInterval)
            })["Hero.useEffect"];
        }
    }["Hero.useEffect"], []);
            ...
            if (progress >= 100) {
                const timeout = setTimeout({
                    "Hero.useEffect.timeout": ()=>{
                        setCurrent({
                            "Hero.useEffect.timeout": (c)=>c === SLIDES.length - 1 ? 0 : c + 1
                        }["Hero.useEffect.timeout"]);
                        setProgress(0);
                    }
                }["Hero.useEffect.timeout"], 50);
                return ({
...
_s(Hero, "Ixbrq8luaQrRtUlrRy1ctLdZnp0=");
_c = Hero;
var _c;
...
"[project]/src/components/home/PropertyGrid.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_0180bd16._.js.map